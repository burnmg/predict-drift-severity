...
public class HoeffdingTreeADWIN extends AbstractClassifier
{
	 ...
	 * with 1000 tuples", "VFML method with 10 bins", "VFML method with 100 bins
	...
	public ADWIN adwin = new ADWIN(0.00001);
	...
	public static class Node extends AbstractMOAObject
	{
		...
		public double[] getClassVotes(Instance inst, HoeffdingTreeADWIN ht)
		{
			return this.observedClassDistribution.getArrayCopy();
		}
		...
		public void describeSubtree(HoeffdingTreeADWIN ht, StringBuilder out, int indent)
		{
	...
	public static class SplitNode extends Node
	{
		...
		protected AutoExpandVector<Node> children; // = new
													// AutoExpandVector<Node>();
	...
	public static abstract class LearningNode extends Node
	{
		...
		public abstract void learnFromInstance(Instance inst, HoeffdingTreeADWIN ht);
	}
	...
	public static class InactiveLearningNode extends LearningNode
	{
		...
		@Override
		public void learnFromInstance(Instance inst, HoeffdingTreeADWIN ht)
		{
	...
	public static class ActiveLearningNode extends LearningNode
	{
		...
		public AttributeSplitSuggestion[] getBestSplitSuggestions(SplitCriterion criterion, HoeffdingTreeADWIN ht)
		{
			...
			if (!ht.noPrePruneOption.isSet())
			{
				...
				bestSuggestions.add(new AttributeSplitSuggestion(null, new double[0][],
						criterion.getMeritOfSplit(preSplitDist, new double[][]
						{ preSplitDist })));
			}
	...
	public static class LearningNodeNBAdaptive extends LearningNodeNB
	{
		...
		public void learnFromInstance(Instance inst, HoeffdingTreeADWIN ht)
		{
			...
			if (Utils.maxIndex(NaiveBayes.doNaiveBayesPrediction(inst, this.observedClassDistribution,
					this.attributeObservers)) == trueClass)
			{
