 ...
 * inﬁnitely many examples. See for details:
 * </p>
 *
 * <p>
 * G. Hulten, L. Spencer, and P. Domingos. Mining time-changing data streams. In
 * KDD’01, pages 97–106, San Francisco, CA, 2001. ACM Press.
 * </p>
 *
 * <p>
 * Parameters:
 ...
 * <li>-g : The number of instances a leaf should observe between split attempts
 * </li>
 * <li>-s : Split criterion to use. Example : InfoGainSplitCriterion</li>
 * <li>-c : The allowable error in split decision, values closer to 0 will take
 * longer to decide</li>
 * <li>-t : Threshold below which a split will be forced to break ties</li>
 * <li>-b : Only allow binary splits</li>
 * <li>-z : Stop growing as soon as memory limit is hit</li>
